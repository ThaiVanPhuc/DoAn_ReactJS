...
const AdminProductPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formPayload.append("Cat", formData.Cat);
      ...
      if (formData.id) {
        await productServices.updateProduct(formData.id, formPayload, token);
      } else {
        await productServices.createProduct(formPayload, token);
      }
